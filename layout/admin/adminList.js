exports.content = ()=>{
    ...
    <article class="content_container">
        <h3 class="title_text"><img src="../public/img/admin/main/hb_silver.png" alt="메뉴 아이콘"> 관리자 리스트</h3>
        ...
        <div class="long_table_box">
            ...
            <input type="button" value="관리자 등록" class="join_btn">
        </div>
        <script src="../public/js/admin/adminList.js"></script>
    `
    return template;
}